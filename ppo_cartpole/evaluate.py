...
def main():
    parser = argparse.ArgumentParser(
        description="Evaluate trained CartPole-v1 PPO agent"
    )
    parser.add_argument(
    ...
    policy_net.load_state_dict(torch.load("models_cartpole/cartpole_ppo_policy.pth"))
    policy_net.eval()
