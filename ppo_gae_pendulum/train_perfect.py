...
def main():
    ...
    assert (
        cfg.rollout_steps % cfg.minibatch_size == 0
    ), "minibatch_size must divide rollout_steps"
    ...
    torch.save(ac.state_dict(), "models_pendulum/pendulum_ppo_gae_ac.pth")
    print("Saved: models_pendulum/pendulum_ppo_gae_ac.pth")
